 ...
 * ```
 */
export declare class HttpApi extends Construct {
    #private;
     ...
     * ```
     */
    addFunctionIntegration(path: string, lambdaFunction: IFunction, methods?: HttpMethodType[], options?: AddFunctionIntegrationOptions): void;
    /**
     ...
     * ```
     */
    static createAuthorizerFunction(id: string, authorizerFunction: IFunction, props?: CreateAuthorizerFunctionProps): HttpLambdaAuthorizer;
}
