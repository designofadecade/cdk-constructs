...
[![npm version](https://badge.fury.io/js/%40designofadecade%2Fcdk-constructs.svg)](https://badge.fury.io/js/%40designofadecade%2Fcdk-constructs)
...
3. **Update package.json**
   ```json
   {
     "name": "@designofadecade/cdk-constructs",
     "publishConfig": {
